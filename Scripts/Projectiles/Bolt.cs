...
public class Bolt : Projectile
{
    ...
    public Bolt(uint _id, GameController.IFF _iff, uint _type, float _curvature, float _damage, Vector3 _position, Quaternion _rotation, Vector3 _velocity, float _speed, float _lifetime)
    {
        this.ID = _id;
        this.IFF = _iff;
